...
import wooflabImage from '../../../../../public/images/wooflab.png'
    ...
    <S.Wrapper>
      <S.Inner>
        <S.LeftWrapper>
          ...
          <Header width={['160px', '160px', 'auto']}>{t('Powered by Woof Labs')}</Header>
        ...
        <RightWrapper>
          {isDesktop ? (
            <Image src={wooflabImage} alt="PerpetualBanner" width={640} height={251} placeholder="blur" />
          ) : (
            <Image src={wooflabImage} alt="PerpetualBanner" width={640} height={251} placeholder="blur" />
          )}
        </RightWrapper>
