...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.BSC]: '0x0dA1e442397A378D7B99Cb570CDC4cB745F966b5',
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC]: [bscTokens.busd, bscTokens.woof],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
}
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.RINKEBY]: [USDC[ChainId.RINKEBY], WNATIVE[ChainId.RINKEBY], BUSD[ChainId.RINKEBY]],
  [ChainId.GOERLI]: [USDC[ChainId.GOERLI], WNATIVE[ChainId.GOERLI], BUSD[ChainId.GOERLI]],
  [ChainId.BSC]: [bscTokens.wbnb, bscTokens.usdc, bscTokens.busd, bscTokens.usdt, bscTokens.cake],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
}
...
// CAKE
export const DEFAULT_OUTPUT_CURRENCY = '0xd4cb72ac8fb75c0178a2e3d2b87f77e2b7ead3f2'
